...
namespace TgBot {
    ...
    Update::Ptr TgTypeParser::parseJsonAndGetUpdate(const boost::property_tree::ptree &data) const {
        ...
        result->editedChannelPost = tryParseJson<Message>(&TgTypeParser::parseJsonAndGetMessage, data,
                                                          "edited_channel_post");
        result->inlineQuery = tryParseJson<InlineQuery>(&TgTypeParser::parseJsonAndGetInlineQuery, data,
                                                        "inline_query");
        result->chosenInlineResult = tryParseJson<ChosenInlineResult>(&TgTypeParser::parseJsonAndGetChosenInlineResult,
                                                                      data, "chosen_inline_result");
        result->callbackQuery = tryParseJson<CallbackQuery>(&TgTypeParser::parseJsonAndGetCallbackQuery, data,
                                                            "callback_query");
        result->shippingQuery = tryParseJson<ShippingQuery>(&TgTypeParser::parseJsonAndGetShippingQuery, data,
                                                            "shipping_query");
        result->preCheckoutQuery = tryParseJson<PreCheckoutQuery>(&TgTypeParser::parseJsonAndGetPreCheckoutQuery, data,
                                                                  "pre_checkout_query");
        ...
        result->myChatMember = tryParseJson<ChatMemberUpdated>(&TgTypeParser::parseJsonAndGetChatMemberUpdated, data,
                                                               "my_chat_member");
        result->chatMember = tryParseJson<ChatMemberUpdated>(&TgTypeParser::parseJsonAndGetChatMemberUpdated, data,
                                                             "chat_member");
        result->chatJoinRequest = tryParseJson<ChatJoinRequest>(&TgTypeParser::parseJsonAndGetChatJoinRequest, data,
                                                                "chat_join_request");
        return result;
    }
    ...
    Chat::Ptr TgTypeParser::parseJsonAndGetChat(const boost::property_tree::ptree &data) const {
        ...
        result->permissions = tryParseJson<ChatPermissions>(&TgTypeParser::parseJsonAndGetChatPermissions, data,
                                                            "permissions");
    ...
    Message::Ptr TgTypeParser::parseJsonAndGetMessage(const boost::property_tree::ptree &data) const {
        ...
        result->entities = parseJsonAndGetArray<MessageEntity>(&TgTypeParser::parseJsonAndGetMessageEntity, data,
                                                               "entities");
        ...
        result->captionEntities = parseJsonAndGetArray<MessageEntity>(&TgTypeParser::parseJsonAndGetMessageEntity, data,
                                                                      "caption_entities");
        ...
        result->newChatMembers = parseJsonAndGetArray<User>(&TgTypeParser::parseJsonAndGetUser, data,
                                                            "new_chat_members");
        ...
        result->newChatPhoto = parseJsonAndGetArray<PhotoSize>(&TgTypeParser::parseJsonAndGetPhotoSize, data,
                                                               "new_chat_photo");
        ...
        result->writeAccessAllowed = tryParseJson<WriteAccessAllowed>(&TgTypeParser::parseJsonAndGetWriteAccessAllowed,
                                                                      data, "write_access_allowed");
        result->passportData = tryParseJson<PassportData>(&TgTypeParser::parseJsonAndGetPassportData, data,
                                                          "passport_data");
        ...
        result->forumTopicEdited = tryParseJson<ForumTopicEdited>(&TgTypeParser::parseJsonAndGetForumTopicEdited, data,
                                                                  "forum_topic_edited");
        result->forumTopicClosed = tryParseJson<ForumTopicClosed>(&TgTypeParser::parseJsonAndGetForumTopicClosed, data,
                                                                  "forum_topic_closed");
        result->forumTopicReopened = tryParseJson<ForumTopicReopened>(&TgTypeParser::parseJsonAndGetForumTopicReopened,
                                                                      data, "forum_topic_reopened");
        ...
        result->videoChatScheduled = tryParseJson<VideoChatScheduled>(&TgTypeParser::parseJsonAndGetVideoChatScheduled,
                                                                      data, "video_chat_scheduled");
        result->videoChatStarted = tryParseJson<VideoChatStarted>(&TgTypeParser::parseJsonAndGetVideoChatStarted, data,
                                                                  "video_chat_started");
        result->videoChatEnded = tryParseJson<VideoChatEnded>(&TgTypeParser::parseJsonAndGetVideoChatEnded, data,
                                                              "video_chat_ended");
    ...
    Poll::Ptr TgTypeParser::parseJsonAndGetPoll(const boost::property_tree::ptree &data) const {
        ...
        result->explanationEntities = parseJsonAndGetArray<MessageEntity>(&TgTypeParser::parseJsonAndGetMessageEntity,
    ...
    ProximityAlertTriggered::Ptr
    TgTypeParser::parseJsonAndGetProximityAlertTriggered(const boost::property_tree::ptree &data) const {
    ...
    MessageAutoDeleteTimerChanged::Ptr
    TgTypeParser::parseJsonAndGetMessageAutoDeleteTimerChanged(const boost::property_tree::ptree &data) const {
    ...
    std::string
    TgTypeParser::parseMessageAutoDeleteTimerChanged(const MessageAutoDeleteTimerChanged::Ptr &object) const {
        if (!object) {
            return "";
        }
        std::string result;
    ...
    ForumTopicCreated::Ptr
    TgTypeParser::parseJsonAndGetForumTopicCreated(const boost::property_tree::ptree &data) const {
    ...
    ForumTopicReopened::Ptr
    TgTypeParser::parseJsonAndGetForumTopicReopened(const boost::property_tree::ptree &data) const {
    ...
    GeneralForumTopicHidden::Ptr
    TgTypeParser::parseJsonAndGetGeneralForumTopicHidden(const boost::property_tree::ptree &data) const {
    ...
    GeneralForumTopicUnhidden::Ptr
    TgTypeParser::parseJsonAndGetGeneralForumTopicUnhidden(const boost::property_tree::ptree &data) const {
    ...
    WriteAccessAllowed::Ptr
    TgTypeParser::parseJsonAndGetWriteAccessAllowed(const boost::property_tree::ptree &data) const {
    ...
    VideoChatScheduled::Ptr
    TgTypeParser::parseJsonAndGetVideoChatScheduled(const boost::property_tree::ptree &data) const {
    ...
    VideoChatParticipantsInvited::Ptr
    TgTypeParser::parseJsonAndGetVideoChatParticipantsInvited(const boost::property_tree::ptree &data) const {
    ...
    UserProfilePhotos::Ptr
    TgTypeParser::parseJsonAndGetUserProfilePhotos(const boost::property_tree::ptree &data) const {
    ...
    TgTypeParser::parseJsonAndGetReplyKeyboardMarkup(const boost::property_tree::ptree &data) const {
    ...
    KeyboardButton::Ptr TgTypeParser::parseJsonAndGetKeyboardButton(const boost::property_tree::ptree &data) const {
        ...
        result->text = data.get<std::string>("text", "");
        result->requestUser = tryParseJson<KeyboardButtonRequestUser>(
                &TgTypeParser::parseJsonAndGetKeyboardButtonRequestUser, data, "request_user");
        ...
        result->requestPoll = tryParseJson<KeyboardButtonPollType>(&TgTypeParser::parseJsonAndGetKeyboardButtonPollType,
                                                                   data, "request_poll");
    ...
    TgTypeParser::parseJsonAndGetKeyboardButtonRequestUser(const boost::property_tree::ptree &data) const {
    ...
    TgTypeParser::parseJsonAndGetKeyboardButtonRequestChat(const boost::property_tree::ptree &data) const {
    ...
    TgTypeParser::parseJsonAndGetKeyboardButtonPollType(const boost::property_tree::ptree &data) const {
    ...
    TgTypeParser::parseJsonAndGetReplyKeyboardRemove(const boost::property_tree::ptree &data) const {
    ...
    TgTypeParser::parseJsonAndGetInlineKeyboardMarkup(const boost::property_tree::ptree &data) const {
        ...
        for (const auto &item: data.find("inline_keyboard")->second) {
            result->inlineKeyboard.push_back(
                    parseJsonAndGetArray<InlineKeyboardButton>(&TgTypeParser::parseJsonAndGetInlineKeyboardButton,
                                                               item.second));
        }
        return result;
    }
    ...
    InlineKeyboardButton::Ptr
    TgTypeParser::parseJsonAndGetInlineKeyboardButton(const boost::property_tree::ptree &data) const {
        ...
        result->callbackGame = tryParseJson<CallbackGame>(&TgTypeParser::parseJsonAndGetCallbackGame, data,
                                                          "callback_game");
    ...
    TgTypeParser::parseJsonAndGetChatAdministratorRights(const boost::property_tree::ptree &data) const {
    ...
    ChatMemberAdministrator::Ptr
    TgTypeParser::parseJsonAndGetChatMemberAdministrator(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetChatMember().
    ...
    ChatMemberRestricted::Ptr
    TgTypeParser::parseJsonAndGetChatMemberRestricted(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetChatMember().
    ...
    ChatMemberUpdated::Ptr
    TgTypeParser::parseJsonAndGetChatMemberUpdated(const boost::property_tree::ptree &data) const {
        ...
        result->oldChatMember = tryParseJson<ChatMember>(&TgTypeParser::parseJsonAndGetChatMember, data,
                                                         "old_chat_member");
        result->newChatMember = tryParseJson<ChatMember>(&TgTypeParser::parseJsonAndGetChatMember, data,
                                                         "new_chat_member");
        result->inviteLink = tryParseJson<ChatInviteLink>(&TgTypeParser::parseJsonAndGetChatInviteLink, data,
                                                          "invite_link");
        return result;
    }
    ...
    BotCommandScope::Ptr TgTypeParser::parseJsonAndGetBotCommandScope(const boost::property_tree::ptree &data) const {
        ...
        if (type == BotCommandScopeDefault::TYPE) {
            ...
            result = std::static_pointer_cast<BotCommandScope>(
                    parseJsonAndGetBotCommandScopeAllChatAdministrators(data));
    ...
    std::string TgTypeParser::parseBotCommandScope(const BotCommandScope::Ptr &object) const {
        ...
        if (object->type == BotCommandScopeDefault::TYPE) {
            ...
            result += parseBotCommandScopeAllPrivateChats(
                    std::static_pointer_cast<BotCommandScopeAllPrivateChats>(object));
    ...
    BotCommandScopeDefault::Ptr
    TgTypeParser::parseJsonAndGetBotCommandScopeDefault(const boost::property_tree::ptree &data) const {
    ...
    BotCommandScopeAllPrivateChats::Ptr
    TgTypeParser::parseJsonAndGetBotCommandScopeAllPrivateChats(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetBotCommandScope().
    ...
    std::string
    TgTypeParser::parseBotCommandScopeAllPrivateChats(const BotCommandScopeAllPrivateChats::Ptr &object) const {
        if (!object) {
            return "";
        }
        // This function will be called by parseBotCommandScope(), so I don't add
    ...
    BotCommandScopeAllGroupChats::Ptr
    TgTypeParser::parseJsonAndGetBotCommandScopeAllGroupChats(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetBotCommandScope().
    ...
    BotCommandScopeAllChatAdministrators::Ptr
    TgTypeParser::parseJsonAndGetBotCommandScopeAllChatAdministrators(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetBotCommandScope().
    ...
    BotCommandScopeChat::Ptr
    TgTypeParser::parseJsonAndGetBotCommandScopeChat(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetBotCommandScope().
    ...
    BotCommandScopeChatAdministrators::Ptr
    TgTypeParser::parseJsonAndGetBotCommandScopeChatAdministrators(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetBotCommandScope().
    ...
    std::string
    TgTypeParser::parseBotCommandScopeChatAdministrators(const BotCommandScopeChatAdministrators::Ptr &object) const {
        if (!object) {
            return "";
        }
        // This function will be called by parseBotCommandScope(), so I don't add
    ...
    BotCommandScopeChatMember::Ptr
    TgTypeParser::parseJsonAndGetBotCommandScopeChatMember(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetBotCommandScope().
    ...
    MenuButtonCommands::Ptr
    TgTypeParser::parseJsonAndGetMenuButtonCommands(const boost::property_tree::ptree &data) const {
    ...
    MenuButtonDefault::Ptr
    TgTypeParser::parseJsonAndGetMenuButtonDefault(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetMenuButton().
    ...
    ResponseParameters::Ptr
    TgTypeParser::parseJsonAndGetResponseParameters(const boost::property_tree::ptree &data) const {
    ...
    InputMediaAnimation::Ptr
    TgTypeParser::parseJsonAndGetInputMediaAnimation(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInputMedia().
    ...
    InputMediaDocument::Ptr
    TgTypeParser::parseJsonAndGetInputMediaDocument(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInputMedia().
    ...
    Sticker::Ptr TgTypeParser::parseJsonAndGetSticker(const boost::property_tree::ptree &data) const {
        ...
        result->maskPosition = tryParseJson<MaskPosition>(&TgTypeParser::parseJsonAndGetMaskPosition, data,
                                                          "mask_position");
        result->customEmojiId = data.get<std::string>("custom_emoji_id", "");
        result->fileSize = data.get<std::int32_t>("file_size", 0);
        return result;
    ...
    InlineQueryResult::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResult(const boost::property_tree::ptree &data) const {
        std::string type = data.get<std::string>("type", "");
    ...
    std::string TgTypeParser::parseInlineQueryResult(const InlineQueryResult::Ptr &object) const {
        ...
        if (object->type == InlineQueryResultCachedAudio::TYPE) {
            ...
            result += parseInlineQueryResultCachedSticker(
                    std::static_pointer_cast<InlineQueryResultCachedSticker>(object));
    ...
    InlineQueryResultArticle::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultArticle(const boost::property_tree::ptree &data) const {
    ...
    InlineQueryResultPhoto::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultPhoto(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultGif::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultGif(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultMpeg4Gif::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultMpeg4Gif(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultVideo::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultVideo(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultAudio::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultAudio(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultVoice::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultVoice(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultDocument::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultDocument(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultLocation::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultLocation(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultVenue::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultVenue(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultContact::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultContact(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultGame::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultGame(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultCachedPhoto::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultCachedPhoto(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultCachedGif::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultCachedGif(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultCachedMpeg4Gif::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultCachedMpeg4Gif(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    std::string
    TgTypeParser::parseInlineQueryResultCachedMpeg4Gif(const InlineQueryResultCachedMpeg4Gif::Ptr &object) const {
        if (!object) {
            return "";
        }
        // This function will be called by parseInlineQueryResult(), so I don't add
    ...
    InlineQueryResultCachedSticker::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultCachedSticker(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    std::string
    TgTypeParser::parseInlineQueryResultCachedSticker(const InlineQueryResultCachedSticker::Ptr &object) const {
        if (!object) {
            return "";
        }
        // This function will be called by parseInlineQueryResult(), so I don't add
    ...
    InlineQueryResultCachedDocument::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultCachedDocument(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    std::string
    TgTypeParser::parseInlineQueryResultCachedDocument(const InlineQueryResultCachedDocument::Ptr &object) const {
        if (!object) {
            return "";
        }
        // This function will be called by parseInlineQueryResult(), so I don't add
    ...
    InlineQueryResultCachedVideo::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultCachedVideo(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultCachedVoice::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultCachedVoice(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    InlineQueryResultCachedAudio::Ptr
    TgTypeParser::parseJsonAndGetInlineQueryResultCachedAudio(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInlineQueryResult().
    ...
    TgTypeParser::parseJsonAndGetInputMessageContent(const boost::property_tree::ptree &data) const {
    ...
    InputTextMessageContent::Ptr
    TgTypeParser::parseJsonAndGetInputTextMessageContent(const boost::property_tree::ptree &data) const {
    ...
    InputLocationMessageContent::Ptr
    TgTypeParser::parseJsonAndGetInputLocationMessageContent(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInputMessageContent().
    ...
    InputVenueMessageContent::Ptr
    TgTypeParser::parseJsonAndGetInputVenueMessageContent(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInputMessageContent().
    ...
    InputContactMessageContent::Ptr
    TgTypeParser::parseJsonAndGetInputContactMessageContent(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInputMessageContent().
    ...
    InputInvoiceMessageContent::Ptr
    TgTypeParser::parseJsonAndGetInputInvoiceMessageContent(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetInputMessageContent().
    ...
    ChosenInlineResult::Ptr
    TgTypeParser::parseJsonAndGetChosenInlineResult(const boost::property_tree::ptree &data) const {
    ...
    TgTypeParser::parseJsonAndGetSentWebAppMessage(const boost::property_tree::ptree &data) const {
    ...
    SuccessfulPayment::Ptr
    TgTypeParser::parseJsonAndGetSuccessfulPayment(const boost::property_tree::ptree &data) const {
    ...
    EncryptedPassportElement::Ptr
    TgTypeParser::parseJsonAndGetEncryptedPassportElement(const boost::property_tree::ptree &data) const {
        ...
        result->translation = parseJsonAndGetArray<PassportFile>(&TgTypeParser::parseJsonAndGetPassportFile, data,
                                                                 "translation");
    ...
    EncryptedCredentials::Ptr
    TgTypeParser::parseJsonAndGetEncryptedCredentials(const boost::property_tree::ptree &data) const {
    ...
    PassportElementError::Ptr
    TgTypeParser::parseJsonAndGetPassportElementError(const boost::property_tree::ptree &data) const {
        ...
        if (source == PassportElementErrorDataField::SOURCE) {
            ...
            result = std::static_pointer_cast<PassportElementError>(
                    parseJsonAndGetPassportElementErrorReverseSide(data));
            ...
            result = std::static_pointer_cast<PassportElementError>(
                    parseJsonAndGetPassportElementErrorUnspecified(data));
        } else {
    ...
    std::string TgTypeParser::parsePassportElementError(const PassportElementError::Ptr &object) const {
        ...
        if (object->source == PassportElementErrorDataField::SOURCE) {
            result += parsePassportElementErrorDataField(
                    std::static_pointer_cast<PassportElementErrorDataField>(object));
        } else if (object->source == PassportElementErrorFrontSide::SOURCE) {
            result += parsePassportElementErrorFrontSide(
                    std::static_pointer_cast<PassportElementErrorFrontSide>(object));
    ...
    PassportElementErrorDataField::Ptr
    TgTypeParser::parseJsonAndGetPassportElementErrorDataField(const boost::property_tree::ptree &data) const {
    ...
    std::string
    TgTypeParser::parsePassportElementErrorDataField(const PassportElementErrorDataField::Ptr &object) const {
        if (!object) {
            return "";
        }
    ...
    PassportElementErrorFrontSide::Ptr
    TgTypeParser::parseJsonAndGetPassportElementErrorFrontSide(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetPassportElementError().
    ...
    std::string
    TgTypeParser::parsePassportElementErrorFrontSide(const PassportElementErrorFrontSide::Ptr &object) const {
        if (!object) {
            return "";
        }
        // This function will be called by parsePassportElementError(), so I don't add
    ...
    PassportElementErrorReverseSide::Ptr
    TgTypeParser::parseJsonAndGetPassportElementErrorReverseSide(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetPassportElementError().
    ...
    std::string
    TgTypeParser::parsePassportElementErrorReverseSide(const PassportElementErrorReverseSide::Ptr &object) const {
        if (!object) {
            return "";
        }
        // This function will be called by parsePassportElementError(), so I don't add
    ...
    PassportElementErrorSelfie::Ptr
    TgTypeParser::parseJsonAndGetPassportElementErrorSelfie(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetPassportElementError().
    ...
    PassportElementErrorFile::Ptr
    TgTypeParser::parseJsonAndGetPassportElementErrorFile(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetPassportElementError().
    ...
    PassportElementErrorFiles::Ptr
    TgTypeParser::parseJsonAndGetPassportElementErrorFiles(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetPassportElementError().
    ...
    PassportElementErrorTranslationFile::Ptr
    TgTypeParser::parseJsonAndGetPassportElementErrorTranslationFile(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetPassportElementError().
    ...
    PassportElementErrorTranslationFiles::Ptr
    TgTypeParser::parseJsonAndGetPassportElementErrorTranslationFiles(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetPassportElementError().
    ...
    PassportElementErrorUnspecified::Ptr
    TgTypeParser::parseJsonAndGetPassportElementErrorUnspecified(const boost::property_tree::ptree &data) const {
        // NOTE: This function will be called by parseJsonAndGetPassportElementError().
    ...
    std::string
    TgTypeParser::parsePassportElementErrorUnspecified(const PassportElementErrorUnspecified::Ptr &object) const {
        if (!object) {
            return "";
        }
        // This function will be called by parsePassportElementError(), so I don't add
    ...
    Game::Ptr TgTypeParser::parseJsonAndGetGame(const boost::property_tree::ptree &data) const {
        ...
        result->photo = parseJsonAndGetArray<PhotoSize>(&TgTypeParser::parseJsonAndGetPhotoSize, data, "photo");
        result->text = data.get("text", "");
        result->textEntities = parseJsonAndGetArray<MessageEntity>(&TgTypeParser::parseJsonAndGetMessageEntity, data,
                                                                   "text_entities");
        result->animation = tryParseJson<Animation>(&TgTypeParser::parseJsonAndGetAnimation, data, "animation");
        return result;
    }
    ...
    void TgTypeParser::appendToJson(std::string &json, const std::string &varName, std::string_view value) const {
        if (value.empty()) {
            return;
        }
        json += '"';
