...
namespace TgBot {
    ...
    public:
        ...
        parseJsonAndGetProximityAlertTriggered(const boost::property_tree::ptree &data) const;

        std::string parseProximityAlertTriggered(const ProximityAlertTriggered::Ptr &object) const;

        MessageAutoDeleteTimerChanged::Ptr
        parseJsonAndGetMessageAutoDeleteTimerChanged(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetGeneralForumTopicHidden(const boost::property_tree::ptree &data) const;

        std::string parseGeneralForumTopicHidden(const GeneralForumTopicHidden::Ptr &object) const;

        GeneralForumTopicUnhidden::Ptr
        parseJsonAndGetGeneralForumTopicUnhidden(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetVideoChatParticipantsInvited(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetKeyboardButtonRequestUser(const boost::property_tree::ptree &data) const;

        std::string parseKeyboardButtonRequestUser(const KeyboardButtonRequestUser::Ptr &object) const;

        KeyboardButtonRequestChat::Ptr
        parseJsonAndGetKeyboardButtonRequestChat(const boost::property_tree::ptree &data) const;

        std::string parseKeyboardButtonRequestChat(const KeyboardButtonRequestChat::Ptr &object) const;

        KeyboardButtonPollType::Ptr
        parseJsonAndGetKeyboardButtonPollType(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetChatAdministratorRights(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetChatMemberAdministrator(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetBotCommandScopeDefault(const boost::property_tree::ptree &data) const;

        std::string parseBotCommandScopeDefault(const BotCommandScopeDefault::Ptr &object) const;

        BotCommandScopeAllPrivateChats::Ptr
        parseJsonAndGetBotCommandScopeAllPrivateChats(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetBotCommandScopeAllGroupChats(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetBotCommandScopeAllChatAdministrators(const boost::property_tree::ptree &data) const;

        std::string
        parseBotCommandScopeAllChatAdministrators(const BotCommandScopeAllChatAdministrators::Ptr &object) const;
        ...
        parseJsonAndGetBotCommandScopeChatAdministrators(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetBotCommandScopeChatMember(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetInlineQueryResultArticle(const boost::property_tree::ptree &data) const;

        std::string parseInlineQueryResultArticle(const InlineQueryResultArticle::Ptr &object) const;

        InlineQueryResultPhoto::Ptr
        parseJsonAndGetInlineQueryResultPhoto(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetInlineQueryResultCachedPhoto(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetInlineQueryResultCachedGif(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetInlineQueryResultCachedMpeg4Gif(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetInlineQueryResultCachedSticker(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetInlineQueryResultCachedDocument(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetInlineQueryResultCachedVideo(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetInlineQueryResultCachedVoice(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetInlineQueryResultCachedAudio(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetInputTextMessageContent(const boost::property_tree::ptree &data) const;

        std::string parseInputTextMessageContent(const InputTextMessageContent::Ptr &object) const;

        InputLocationMessageContent::Ptr
        parseJsonAndGetInputLocationMessageContent(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetInputVenueMessageContent(const boost::property_tree::ptree &data) const;

        std::string parseInputVenueMessageContent(const InputVenueMessageContent::Ptr &object) const;

        InputContactMessageContent::Ptr
        parseJsonAndGetInputContactMessageContent(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetInputInvoiceMessageContent(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetEncryptedPassportElement(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetPassportElementErrorDataField(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetPassportElementErrorFrontSide(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetPassportElementErrorReverseSide(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetPassportElementErrorSelfie(const boost::property_tree::ptree &data) const;

        std::string parsePassportElementErrorSelfie(const PassportElementErrorSelfie::Ptr &object) const;

        PassportElementErrorFile::Ptr
        parseJsonAndGetPassportElementErrorFile(const boost::property_tree::ptree &data) const;

        std::string parsePassportElementErrorFile(const PassportElementErrorFile::Ptr &object) const;

        PassportElementErrorFiles::Ptr
        parseJsonAndGetPassportElementErrorFiles(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetPassportElementErrorTranslationFile(const boost::property_tree::ptree &data) const;

        std::string
        parsePassportElementErrorTranslationFile(const PassportElementErrorTranslationFile::Ptr &object) const;

        PassportElementErrorTranslationFiles::Ptr
        parseJsonAndGetPassportElementErrorTranslationFiles(const boost::property_tree::ptree &data) const;

        std::string
        parsePassportElementErrorTranslationFiles(const PassportElementErrorTranslationFiles::Ptr &object) const;

        PassportElementErrorUnspecified::Ptr
        parseJsonAndGetPassportElementErrorUnspecified(const boost::property_tree::ptree &data) const;
        ...
        parseJsonAndGetArray(JsonToTgTypeFunc<T> parseFunc, const boost::property_tree::ptree &data) const {
        ...
        std::vector<T> parseJsonAndGetArray(std::function<T(const boost::property_tree::ptree &)> parseFunc,
                                            const boost::property_tree::ptree &data, const std::string &keyName) const {
            std::vector<T> result;
            auto treeItem = data.find(keyName);
            if (treeItem == data.not_found()) {
                return result;
        ...
        template<typename T>
        std::vector<std::shared_ptr<T>>
        parseJsonAndGetArray(JsonToTgTypeFunc<T> parseFunc, const boost::property_tree::ptree &data,
                             const std::string &keyName) const {
            std::vector<std::shared_ptr<T>> result;
            auto treeItem = data.find(keyName);
            if (treeItem == data.not_found()) {
        ...
        parseJsonAndGet2DArray(JsonToTgTypeFunc<T> parseFunc, const boost::property_tree::ptree &data,
                               const std::string &keyName) const {
        ...
        template<typename T>
        std::string
        parse2DArray(TgTypeToJsonFunc<T> parseFunc, const std::vector<std::vector<std::shared_ptr<T>>> &objects) const {
            if (objects.empty())
                return "";
            std::string result;
            result += '[';
    ...
    private:
        ...
        inline void appendToJson(std::string &json, const std::string &varName, int value) const {
            appendToJsonNumber(json, varName, value);
        }

        inline void appendToJson(std::string &json, const std::string &varName, long value) const {
            appendToJsonNumber(json, varName, value);
        }

        inline void appendToJson(std::string &json, const std::string &varName, long long value) const {
            appendToJsonNumber(json, varName, value);
        }

        inline void appendToJson(std::string &json, const std::string &varName, unsigned value) const {
            appendToJsonNumber(json, varName, value);
        }

        inline void appendToJson(std::string &json, const std::string &varName, unsigned long value) const {
            appendToJsonNumber(json, varName, value);
        }

        inline void appendToJson(std::string &json, const std::string &varName,
                                 unsigned long long value) const { appendToJsonNumber(json, varName, value); }

        inline void appendToJson(std::string &json, const std::string &varName, float value) const {
            appendToJsonNumber(json, varName, value);
        }

        inline void appendToJson(std::string &json, const std::string &varName, double value) const {
            appendToJsonNumber(json, varName, value);
        }

        inline void appendToJson(std::string &json, const std::string &varName, long double value) const {
            appendToJsonNumber(json, varName, value);
        }

        inline void appendToJson(std::string &json, const std::string &varName, bool value) const {
            json += '"';
            json += varName;
            json += R"(":)";
        ...
        void appendToJson(std::string &json, const std::string &varName, std::string_view value) const;
    };
}
